    ...
    <div>
        ...
        <div class="mpvue-picker-content " :class="{'mpvue-picker-view-show':showPicker}">
            <div class="mpvue-picker__hd" catchtouchmove="true">
                ...
                <div class="mpvue-picker__action" style="color: black">{{title}}</div>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue"
                ...
                <block>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueSingleArray" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                </block>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue"
                ...
                <block>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueHour" :key="index">{{item.label}}
                        </div>
                    </picker-view-column>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMinute" :key="index">{{item.label}}
                        </div>
                    </picker-view-column>
                </block>
            </picker-view>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue"
                ...
                <block v-for="(n,index) in pickerValueMulArray.length" :key="index">
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index1) in pickerValueMulArray[index]" :key="index1">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                </block>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue"
                ...
                <block>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMulTwoOne" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMulTwoTwo" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                </block>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue"
                ...
                <block>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMulThreeOne" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMulThreeTwo" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                    <picker-view-column>
                        <div class="picker-item" v-for="(item,index) in pickerValueMulThreeThree" :key="index">
                            {{item.label}}
                        </div>
                    </picker-view-column>
                </block>
        ...
        <!--<div :class="showPicker" v-if="showPicker" @click="maskClick" catchtouchmove="true"></div>-->
        <!--<div class="mpvue-picker-content mpvue-picker-view-show" v-if="showPicker">-->
            <!--<div class="mpvue-picker__hd" catchtouchmove="true">-->
                <!--<div class="mpvue-picker__action" @click="pickerCancel">取消</div>-->
                <!--<div class="mpvue-picker__action" style="color: black">{{title}}</div>-->
                <!--<div class="mpvue-picker__action" :style="{color:themeColor}" @click="pickerConfirm">确定</div>-->
